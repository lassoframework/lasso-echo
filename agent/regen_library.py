...
CONCEPTS = {
    ...
    "b2b_16_cpl": {
        ...
        "concept": ["Tension: most gyms overpaying for every single lead and never checking the math.",
                    ...
                    "CTA copy (caption, never rendered): Trusted by 1,000+ gym owners"],
        "story": False,
        "set": "b2b",
        "pillar": "All in one offer",
        "layout": "chart",
    ...
    "b2b_500_gyms": {
        "headline": "1,000+ gym owners deep. We know exactly why gyms stall.",
        "cite": ["Trusted by 1,000+ gym owners"],
